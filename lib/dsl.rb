...
module CellInfo
  class Dsl
    attr_accessor :device_id, :line1number, :cell_info_object, :cell_location_object, :cell_ping_object, :cell_netstate_object, :cell_report_object, :ingested_json_data, :ingested_location_data, 
    ...
    def initialize(cell_device_id="", cell_line1number="", cell_info_data={}, cell_location_data={}, cell_ping_data={}, cell_netstate_data={}, cell_report_data={}, cell_timestamp={})      
      ...
      if cell_device_id && cell_device_id != ''       
        ...
        begin
          ...
          puts "----------->Parsed success report info #{@cell_report_object.inspect}" if cell_report_data && !cell_report_data.empty?       
